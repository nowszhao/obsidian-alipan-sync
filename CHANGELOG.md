...
> Versions prior to 0.8.0 contain references to the original Nutstore (坚果云) implementation.
> Starting from 0.8.x, the backend was migrated to Alipan (阿里云盘) Open API.
>
> **说明**: 本项目 fork 自 [Obsidian Nutstore Sync](https://github.com/nutstore/obsidian-nutstore-sync)。
